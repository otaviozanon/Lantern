...
export const translations = {
  en: {
    ...
    rulesClose: 'Close',
    reqAny: 'any dice',
    reqGroup: 'identical dice',
    reqFullHouse: 'Full House (3+3 equal)',
    reqBonfire: '🔥 Bonfire (rest)',
    reqSextet: 'Sextet (6 identical)',
    rulesZone5Text: 'Special zones: gain +1 Constitution (+1 free circle on Hard mode). Replace your XP with the Bonfire Scroll value.',
    rulesScoringText: 'Score = total remaining circles. 0: Promising Adventurer, 1-5: Master at Arms, 6-15: Heroic Swashbuckler, 16+: Legendary Lantern Lord.',
  ...
  pt: {
    ...
    rulesClose: 'Fechar',
    reqAny: 'dados quaisquer',
    reqGroup: 'dados idênticos',
    reqFullHouse: 'Full House (3+3 iguais)',
    reqBonfire: '🔥 Fogueira (descanso)',
    reqSextet: 'Sexteto (6 idênticos)',
    rulesZone5Text: 'Zonas especiais: ganhe +1 Constituição (+1 círculo livre no Difícil). Substitua sua EXP pelo valor do Pergaminho.',
    rulesScoringText: 'Pontuação = total de círculos restantes. 0: Aventureiro Promissor, 1-5: Mestre em Armas, 6-15: Espadachim Heroico, 16+: Lendário Senhor da Lanterna.',
